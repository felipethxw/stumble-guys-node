...
module.exports = class StumbleGuys {
    ...
    async getTournamentsList(server) {
        ...
        const options = {
            ...
            body: "sinceDate=2023-02-23T19%3a01%3a48&untilDate=2023-03-12T19%3a01%3a48&maxResults=25&page=1&accessToken="
        };
    ...
    async accountInfo(accessToken) {
        ...
        fetch("https://backbone-client-api.azurewebsites.net/api/v1/userGet", {
            ...
            "body": "lastUpdate=1900-01-01T00%3a00%3a00&lastSync=1900-01-01T00%3a00%3a00&generateQuests=0&getQuests=0&getTiles=0&getLayouts=0&accessToken=",
            "compress": true
        })
            .then(r => r.json())
            .then(data => {
